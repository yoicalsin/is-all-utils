...
export declare const isMapFn: (value: any) => boolean;
export declare const isWeakMap: (value: any) => boolean;
export declare const isWeakMapFn: (value: any) => boolean;
export declare const isSet: (value: any) => boolean;
export declare const isSetFn: (value: any) => boolean;
export declare const isWeakSet: (value: any) => boolean;
export declare const isWeakSetFn: (value: any) => boolean;
